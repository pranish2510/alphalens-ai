    ...
    try {
      ...
      setMessages(prev => [
        ...prev.filter(m => !m.typing),
        {
          ...
          content: null,
          parsed: {
            short: 'Unable to connect to AI service. Please check your API key configuration.',
            context: ['Configure OPENAI_API_KEY or GEMINI_API_KEY in .env.local'],
            signals: [], risks: [],
            action: 'Add your API key to .env.local and restart the server.',
            confidence: 0,
          },
          timestamp: new Date().toISOString(),
        },
